...
(1, 'plant', '白芍种植', '2024-03-15 08:00:00', '张三', '东山药材基地A区', '使用优质白芍种苗进行种植', 1),
(1, 'fertilize', '有机肥施用', '2024-05-10 09:00:00', '张三', '东山药材基地A区', '施加充分腐熟的有机肥200kg', 2),
(1, 'grow', '夏季灌溉', '2024-06-20 06:00:00', '张三', '东山药材基地A区', '采用滴灌方式进行灌溉', 3),
(1, 'harvest', '白芍采收', '2024-10-15 07:00:00', '张三', '东山药材基地A区', '采用人工挖掘方式收获白芍', 4),
(2, 'plant', '丹参种植', '2024-04-01 08:00:00', '张三', '东山药材基地A区', '种植优质丹参种苗', 1),
(2, 'fertilize', '追肥', '2024-06-15 09:00:00', '张三', '东山药材基地A区', '施加复合肥料', 2);
